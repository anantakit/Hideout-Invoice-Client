...
import { parseAddressToThaiAddr, buildAddressString, emptyAddr } from '@/shared/utils/addressUtils'
...
export default function CustomerModal({ open, onClose, onSave, isPending, customer }: Props) {
