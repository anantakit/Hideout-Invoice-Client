 ...
 *   --timeline-cell-width:     6rem  → 96 px (at base font-size 16 px)
 *   --timeline-row-height:     3rem  → 48 px
 *   --timeline-room-col-width: 4.5rem → 72 px
 *
...
export const TIMELINE_CELL_WIDTH_PX = 6 * BASE_FONT_PX      // 96
export const TIMELINE_ROW_HEIGHT_PX  = 3 * BASE_FONT_PX     // 48
export const TIMELINE_ROOM_COL_PX   = 4.5 * BASE_FONT_PX    // 72
