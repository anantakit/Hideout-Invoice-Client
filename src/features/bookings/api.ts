...
export const bookingsApi = {
  ...
  updatePayment: async (bookingId: string, paymentId: string, payload: UpdatePaymentPayload): Promise<PaymentResponse> => {
    const { data } = await apiClient.patch<ApiResponse<PaymentResponse>>(
